...
md = """# Map-viewer .ani → FBX bone contract
...
"""
path = Path(r"C:\Users\Zhibin Ren\jx3-ani-player\proof\compare\MAPVIEWER_BONE_CONTRACT.md")
path.write_text(md, encoding="utf-8")
Path(r"C:\Users\Zhibin Ren\jx3-staging\MAPVIEWER_BONE_CONTRACT.md").write_text(md, encoding="utf-8")
